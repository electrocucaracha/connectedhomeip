...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        emberAfColorControlClusterMoveColorTemperatureCallback(apCommandObj, moveMode, rate, colorTemperatureMinimum, colorTemperatureMaximum, optionsMask, optionsOverride);
        }
else
{
      apCommandObj->AddStatusCode(nullptr, Protocols::SecureChannel::GeneralStatusCode::kBadRequest, Protocols::SecureChannel::Id,
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        emberAfColorControlClusterMoveToColorCallback(apCommandObj, colorX, colorY, transitionTime, optionsMask, optionsOverride);
        }
else
{
      apCommandObj->AddStatusCode(nullptr, Protocols::SecureChannel::GeneralStatusCode::kBadRequest, Protocols::SecureChannel::Id,
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        emberAfColorControlClusterMoveToColorTemperatureCallback(apCommandObj, colorTemperature, transitionTime, optionsMask, optionsOverride);
        }
else
{
      apCommandObj->AddStatusCode(nullptr, Protocols::SecureChannel::GeneralStatusCode::kBadRequest, Protocols::SecureChannel::Id,
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        emberAfColorControlClusterMoveToHueCallback(apCommandObj, hue, direction, transitionTime, optionsMask, optionsOverride);
        }
else
{
      apCommandObj->AddStatusCode(nullptr, Protocols::SecureChannel::GeneralStatusCode::kBadRequest, Protocols::SecureChannel::Id,
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        emberAfColorControlClusterMoveToHueAndSaturationCallback(apCommandObj, hue, saturation, transitionTime, optionsMask, optionsOverride);
        }
else
{
      apCommandObj->AddStatusCode(nullptr, Protocols::SecureChannel::GeneralStatusCode::kBadRequest, Protocols::SecureChannel::Id,
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        emberAfColorControlClusterMoveToSaturationCallback(apCommandObj, saturation, transitionTime, optionsMask, optionsOverride);
        }
else
{
      apCommandObj->AddStatusCode(nullptr, Protocols::SecureChannel::GeneralStatusCode::kBadRequest, Protocols::SecureChannel::Id,
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        emberAfColorControlClusterStepColorCallback(apCommandObj, stepX, stepY, transitionTime, optionsMask, optionsOverride);
        }
else
{
      apCommandObj->AddStatusCode(nullptr, Protocols::SecureChannel::GeneralStatusCode::kBadRequest, Protocols::SecureChannel::Id,
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        emberAfColorControlClusterStepColorTemperatureCallback(apCommandObj, stepMode, stepSize, transitionTime, colorTemperatureMinimum, colorTemperatureMaximum, optionsMask, optionsOverride);
        }
else
{
      apCommandObj->AddStatusCode(nullptr, Protocols::SecureChannel::GeneralStatusCode::kBadRequest, Protocols::SecureChannel::Id,
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        emberAfColorControlClusterStepHueCallback(apCommandObj, stepMode, stepSize, transitionTime, optionsMask, optionsOverride);
        }
else
{
      apCommandObj->AddStatusCode(nullptr, Protocols::SecureChannel::GeneralStatusCode::kBadRequest, Protocols::SecureChannel::Id,
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        emberAfColorControlClusterStepSaturationCallback(apCommandObj, stepMode, stepSize, transitionTime, optionsMask, optionsOverride);
        }
else
{
      apCommandObj->AddStatusCode(nullptr, Protocols::SecureChannel::GeneralStatusCode::kBadRequest, Protocols::SecureChannel::Id,
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        emberAfDoorLockClusterSetHolidayScheduleCallback(apCommandObj, scheduleId, localStartTime, localEndTime, operatingModeDuringHoliday);
        }
else
{
      apCommandObj->AddStatusCode(nullptr, Protocols::SecureChannel::GeneralStatusCode::kBadRequest, Protocols::SecureChannel::Id,
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        emberAfDoorLockClusterSetWeekdayScheduleCallback(apCommandObj, scheduleId, userId, daysMask, startHour, startMinute, endHour, endMinute);
        }
else
{
      apCommandObj->AddStatusCode(nullptr, Protocols::SecureChannel::GeneralStatusCode::kBadRequest, Protocols::SecureChannel::Id,
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        emberAfGeneralCommissioningClusterSetRegulatoryConfigCallback(apCommandObj, location, const_cast<uint8_t*>(countryCode), breadcrumb, timeoutMs);
        }
else
{
      apCommandObj->AddStatusCode(nullptr, Protocols::SecureChannel::GeneralStatusCode::kBadRequest, Protocols::SecureChannel::Id,
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        emberAfLevelControlClusterStepCallback(apCommandObj, stepMode, stepSize, transitionTime, optionMask, optionOverride);
        }
else
{
      apCommandObj->AddStatusCode(nullptr, Protocols::SecureChannel::GeneralStatusCode::kBadRequest, Protocols::SecureChannel::Id,
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        emberAfOtaSoftwareUpdateServerClusterQueryImageCallback(apCommandObj, vendorId, productId, imageType, hardwareVersion, currentVersion, protocolsSupported, const_cast<uint8_t*>(location), clientCanConsent, metadataForServer);
        }
else
{
      apCommandObj->AddStatusCode(nullptr, Protocols::SecureChannel::GeneralStatusCode::kBadRequest, Protocols::SecureChannel::Id,
...
{
// TODO(#5098) We should pass the Command Object and EndpointId to the cluster callbacks.
        emberAfScenesClusterAddSceneCallback(apCommandObj, groupId, sceneId, transitionTime, const_cast<uint8_t*>(sceneName), extensionFieldSets);
        }
else
{
      apCommandObj->AddStatusCode(nullptr, Protocols::SecureChannel::GeneralStatusCode::kBadRequest, Protocols::SecureChannel::Id,
