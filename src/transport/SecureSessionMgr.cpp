...
CHIP_ERROR SecureSessionMgr::NewPairing(const Optional<Transport::PeerAddress> & peerAddr, NodeId peerNodeId,
                                        PairingSession * pairing, PairingDirection direction, AdminId admin,
                                             ...
                                             System::PacketBufferHandle msg)
{
    ...
    // See operational-credentials.cpp for explanation as to why fabricId is being set to commisisoner node id
