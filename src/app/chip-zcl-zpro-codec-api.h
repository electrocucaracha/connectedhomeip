 ...
 */
chip::System::PacketBufferHandle encodeGeneralCommissioningClusterSetRegulatoryConfigCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint8_t location, chip::ByteSpan countryCode, uint64_t breadcrumb, uint32_t timeoutMs);
 ...
 */
chip::System::PacketBufferHandle encodeOperationalCredentialsClusterSetFabricCommand(uint8_t seqNum, chip::EndpointId destinationEndpoint, uint16_t vendorId);
