...
PacketBufferHandle encodeBasicClusterWriteLocalConfigDisabledAttribute(uint8_t seqNum, EndpointId destinationEndpoint, uint8_t localConfigDisabled)
{
 ...
 * Command SetPin
 */
PacketBufferHandle encodeDoorLockClusterSetPinCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint16_t userId, uint8_t userStatus, uint8_t userType, chip::ByteSpan pin)
{
 ...
 * Command SetRfid
 */
PacketBufferHandle encodeDoorLockClusterSetRfidCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint16_t userId, uint8_t userStatus, uint8_t userType, chip::ByteSpan id)
{
 ...
 */
PacketBufferHandle encodeDoorLockClusterUnlockWithTimeoutCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint16_t timeoutInSeconds, chip::ByteSpan pin)
{
 ...
 */
PacketBufferHandle encodeGeneralCommissioningClusterSetRegulatoryConfigCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint8_t location, chip::ByteSpan countryCode, uint64_t breadcrumb, uint32_t timeoutMs)
{
 ...
 */
PacketBufferHandle encodeOperationalCredentialsClusterRemoveFabricCommand(uint8_t seqNum, EndpointId destinationEndpoint, chip::FabricId fabricId, chip::NodeId nodeId, uint16_t vendorId)
{
 ...
 * Command SetFabric
 */
PacketBufferHandle encodeOperationalCredentialsClusterSetFabricCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint16_t vendorId)
{
 ...
 */
PacketBufferHandle encodeOperationalCredentialsClusterUpdateFabricLabelCommand(uint8_t seqNum, EndpointId destinationEndpoint, chip::ByteSpan label)
{
 ...
 */
PacketBufferHandle encodePumpConfigurationAndControlClusterReadEffectiveOperationModeAttribute(uint8_t seqNum, EndpointId destinationEndpoint)
{
 ...
 */
PacketBufferHandle encodePumpConfigurationAndControlClusterReadEffectiveControlModeAttribute(uint8_t seqNum, EndpointId destinationEndpoint)
{
...
PacketBufferHandle encodePumpConfigurationAndControlClusterConfigureCapacityAttribute(uint8_t seqNum, EndpointId destinationEndpoint, uint16_t minInterval, uint16_t maxInterval, int16_t change)
{
 ...
 */
PacketBufferHandle encodePumpConfigurationAndControlClusterReadOperationModeAttribute(uint8_t seqNum, EndpointId destinationEndpoint)
{
...
PacketBufferHandle encodePumpConfigurationAndControlClusterWriteOperationModeAttribute(uint8_t seqNum, EndpointId destinationEndpoint, uint8_t operationMode)
{
 ...
 * Attribute ClusterRevision
 */
PacketBufferHandle encodePumpConfigurationAndControlClusterReadClusterRevisionAttribute(uint8_t seqNum, EndpointId destinationEndpoint)
{
 ...
 * Command AddScene
 */
PacketBufferHandle encodeScenesClusterAddSceneCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint16_t groupId, uint8_t sceneId, uint16_t transitionTime, chip::ByteSpan sceneName, chip::ClusterId clusterId, uint8_t length, uint8_t value)
{
 ...
 */
PacketBufferHandle encodeWindowCoveringClusterWindowCoveringGoToLiftPercentageCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint8_t percentageLiftValue)
{
 ...
 */
PacketBufferHandle encodeWindowCoveringClusterWindowCoveringGoToLiftValueCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint16_t liftValue)
{
 ...
 */
PacketBufferHandle encodeWindowCoveringClusterWindowCoveringGoToTiltPercentageCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint8_t percentageTiltValue)
{
 ...
 */
PacketBufferHandle encodeWindowCoveringClusterWindowCoveringGoToTiltValueCommand(uint8_t seqNum, EndpointId destinationEndpoint, uint16_t tiltValue)
{
...
PacketBufferHandle encodeWindowCoveringClusterConfigureWindowCoveringTypeAttribute(uint8_t seqNum, EndpointId destinationEndpoint, uint16_t minInterval, uint16_t maxInterval)
{
...
PacketBufferHandle encodeWindowCoveringClusterConfigureCurrentPositionLiftAttribute(uint8_t seqNum, EndpointId destinationEndpoint, uint16_t minInterval, uint16_t maxInterval, uint16_t change)
{
...
PacketBufferHandle encodeWindowCoveringClusterConfigureCurrentPositionTiltAttribute(uint8_t seqNum, EndpointId destinationEndpoint, uint16_t minInterval, uint16_t maxInterval, uint16_t change)
{
...
PacketBufferHandle encodeWindowCoveringClusterConfigureConfigStatusAttribute(uint8_t seqNum, EndpointId destinationEndpoint, uint16_t minInterval, uint16_t maxInterval)
{
